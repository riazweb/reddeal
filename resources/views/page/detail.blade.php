		...
		<!--default-js-->
			<script src="detail/js/jquery-2.1.4.min.js"></script>
			{!! Html::script('admin_theme/plugins/jQuery/jQuery-2.1.4.min.js') !!}
		<!--bootstrap-js-->

		<!--script-->
         <!-- FlexSlider -->
            <script src="detail/js/imagezoom.js"></script>
            {!! Html::script('admin_theme/plugins/jQuery/jQuery-2.1.4.min.js') !!}
              <script defer src="detail/js/jquery.flexslider.js"></script>
              {!! Html::script('detail/js/jquery.flexslider.js') !!}
            {!! Html::style('detail/css/flexslider.css') !!}
            <link rel="stylesheet" href="detail/css/flexslider.css" type="text/css" media="screen" />
            ...
            <div class="container">
                <div class="col-md-8 showcase">
                    ...
                    <div class="flexslider">
                         ...
                         <ul class="slides">
                            <li data-thumb="images/product/detail/">
                                <div class="thumb-image"> <img src="images/product/detail/" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="images/product/detail/">
                                 <div class="thumb-image"> <img src="images/product/detail/" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                    ...
                    <div class="shocase-rt-bot">
                        ...
                        <ul>
                            <li class="ad-2-crt simpleCart_shelfItem">
                                ...
                                <a class="btn" href="home/buy/" role="button">Buy Now</a>
                            </li>
                        </ul>
                    </div>
