					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +2 92 00 00 000</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@readdeal.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html">
								{!! Html::image('theme/images/home/logo.png') !!}
							</a>
						</div>
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>$</h2>
												<p></p>
												<a href="home/detail/" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Buy Now</a>
											</div>
										</div>
...
@section("footer")
		<!-- <div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										{!! Html::image('theme/images/home/iframe1.png') !!}
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										{!! Html::image('theme/images/home/iframe2.png') !!}
									<div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										{!! Html::image('theme/images/home/iframe3.png') !!}
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										{!! Html::image('theme/images/home/iframe4.png') !!}
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							{!! Html::image('theme/images/home/map.png') !!}
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2017 Red Deal. All rights reserved.</p>
