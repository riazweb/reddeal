...
@section('main_content')
    {!! Html::script('detail/js/jquery-2.1.4.min.js') !!}
    {!! Html::script('detail/js/imagezoom.js') !!}
    {!! Html::script('detail/js/jquery.flexslider.js') !!}
    {!! Html::style('detail/css/flexslider.css') !!}
        ...
        <div class="container">
            <div class="col-md-8 showcase">
                ...
                <div class="flexslider">
                    @foreach($row as $item)
                    <ul class="slides">
                        <li data-thumb="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}">
                            <div class="thumb-image">
                                <img src="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}" data-imagezoom="true" class="img-responsive">
                            </div>
                        </li>
                        <li data-thumb="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}">
                            <div class="thumb-image"> <img src="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}">
                            <div class="thumb-image"> <img src="{!! 'http://red-deal.riz/public/images/'. $item->big_image !!}" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                ...
                <div class="shocase-rt-bot">
                    ...
                    <ul>
                        <li class="ad-2-crt simpleCart_shelfItem">
                            ...
                            <a class="btn" href="buy/{{ $item->id }}" role="button">Buy Now</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-4 grid-stn simpleCart_shelfItem">
                ...
                <div class="ih-item square effect3 bottom_to_top">
                    <div class="bottom-2-top">
                        <div class="img"><img src="{!! 'http://red-deal.riz/public/images/product8.jpg' !!}" alt="/" class="img-responsive gri-wid"></div>
                        <div class="info">
