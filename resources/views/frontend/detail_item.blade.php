            ...
            <div class="container">
                <div class="col-md-8 showcase">
                    ...
                    <div class="flexslider">
                         ...
                         <ul class="slides">
                            @foreach($data['row'] as $img)
                            <li data-thumb="{{url('uploads/'.$img->filePath)}}">
                                <div class="thumb-image"> 
                                    <img src="{{url('uploads/'.$img->filePath)}}" data-imagezoom="true" class="img-responsive"> 
                                </div>
                            </li>
                            @endforeach
                          </ul>
                    ...
                    <div class="shocase-rt-bot">
                        ...
                        <ul>
                            <li class="ad-2-crt simpleCart_shelfItem">
                                <!--    ` -->
                                <a class="btn" href="{{url('buy/'.$img->item_id)}}" role="button">Buy Now</a>
                            </li>
                        </ul>
                    </div>
